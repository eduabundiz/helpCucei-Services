...
app.get('/api/comments/get', (req, res) =>{
    const sqlStatement= "SELECT P.id, P.idUsuario, P.contenido, P.fecha, P.idPost, P.status, P.comentario, P.estadoAprobacion, A.nombre, A.apellidoPaterno, A.apellidoMaterno, A.correo FROM comentarios AS P INNER JOIN usuarios AS A ON P.idUsuario = A.id;";
    db.query(sqlStatement, (err, result) =>{
        //console.log("RESULT: ",result);
        res.send(result);
    });
